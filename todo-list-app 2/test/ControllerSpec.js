...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		// After analyse, I think the best practice should to test  the view and the model
		// Model test for active entries
		...
		// Model test for the completed entries
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			...
			let todos = [
				...
				{id: 43, title: 'other todo', completed: false}
			]
				setUpModel(todos);		
				subject.setView('');
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
			let todo = {id: 300, title: 'my todo', completed: true};
			setUpModel([todo]);
			subject.setView('');
			view.trigger('itemRemove', {id: 300});
			expect(model.remove).toHaveBeenCalledWith(300, jasmine.any(Function));
		});
